...
"""
# reference: https://blog.csdn.net/weixin_39175124/article/details/79465558
# 1) This part I decide to use linear regression to analyze the passenger flow in Galway
# 2) Spliting dataset into 80% training set and 20% testing set
# 3) Calculating predicting accuracy by using "accuracy_lr" function
# 4) plot the actual value and predicting value
