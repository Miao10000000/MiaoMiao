...
# 3. SVR model, dropping each feature individually
...
for i in list_a:
    ...
    my_dict[i]= predict_value

# calculate the accuracy of dropping features
my_dict.to_csv('/content/drive/My Drive/Colab Notebooks/lr_feature_comparison/SVR_ALL.csv', index=False, header=True)
import matplotlib.pyplot as plt
from google.colab import drive
drive.mount('/content/drive')
!Is "/content/drive/My Drive/Colab Notebooks"
inputfile1 = '/content/drive/My Drive/Colab Notebooks/lr_feature_comparison/SVR_ALL.csv'
...
new_dict.to_csv('/content/drive/My Drive/Colab Notebooks/feature_comparision_with_all_features/SVR.csv')